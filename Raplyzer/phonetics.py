...
#YOU NEED TO REPLACE THIS WITH YOUR CORRESPONDING espeak Command line dir. This is a windows 10 set up.
espeak_dir = "C:\Program Files (x86)\eSpeak\command_line\espeak.exe"
...
def get_phonetic_transcription(text, language='en-us', output_fname=None):
    ...
    if output_fname is None or not os.path.exists(fname2):
        ...
        subprocess.run([espeak_dir,"-xq","-v",language,"-f",fname,">",fname2], shell=True)
        
        ## Alternatively if you have espeak installed to your path directory
